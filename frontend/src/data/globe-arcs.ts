const NAVY = "#0e23e3";
const ARC_COLORS = [NAVY, "#2638e5", "#5664eb"] as const;
...
export const globeArcs = rawArcs.map((arc, index) => ({
  ...arc,
  color: ARC_COLORS[index % ARC_COLORS.length],
}));

export const voyrGlobeConfig = {
  pointSize: 2,
  globeColor: "#ffffff",
  showAtmosphere: true,
  atmosphereColor: "#f3f4fd",
